<template>
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      ...
      <div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-4">
        ...
        <div class="justify-start">
          ...
          <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
            ...
            <div class="py-1">
              <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Delete Reclamation</a>
            </div>
          </div>
        </div>
        <!-- Search Bar -->
        <div class="relative justify-end">
          ...
          <input type="text" id="table-search-reclamations" class="block p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search by Title, User...">
        </div>
      </div>
      ...
      <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr v-for="reclamation in reclamations" :key="reclamation.id" class="hover:bg-gray-50 dark:hover:bg-gray-600">
            <td class="w-4 p-4">
              <div class="flex items-center">
            ...
            <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ reclamation.user }}</td>
            <td class="px-6 py-4">{{ reclamation.title }}</td>
            <td class="px-6 py-4">{{ reclamation.description }}</td>
            <td class="px-6 py-4">
        ...
        reclamations: [
          {
            ...
            description: 'The product was defective and not working as expected.',
          },
          {
            id: '2',
            user: 'marie.martin@example.com',
            title: 'Delivery delay',
            description: 'The delivery was delayed by two weeks without any notice.',
          },
          {
            id: '3',
            user: 'paul.durand@example.com',
