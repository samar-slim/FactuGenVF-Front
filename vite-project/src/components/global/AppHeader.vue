  ...
  <div class="w-full bg-blue-400 ">
    <div class="flex justify-between  items-center h-[50px]">
      ...
      <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-blue-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  ">
        ...
        <li>
          <router-link to="/rechamation" class="block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent font-bold dark:border-gray-700">Rechamation</router-link>
        </li>
      </ul>
    </div>
      <nav>
