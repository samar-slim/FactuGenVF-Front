    ...
    <div class="w-full px-6 py-6 mx-auto">
      ...
      <div class="flex flex-wrap -mx-3">
        ...
        <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
          <div class="relative flex flex-col min-w-0 break-words  bg-gradient-to-tl from-blue-500 to-violet-500 text-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
              ...
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="h-2.5 w-2.5 rounded-full bg-red-500 me-2"></div> Desactivé
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                    ...
                    <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Facture</p>
                ...
                <div class="px-3 text-right basis-1/3">
                  <div class="inline-block w-12 h-12 text-center rounded-circle bg-white">
                    <i class="ni leading-none ni-money-coins text-lg relative top-3.5 text-gray-900"><i class="fa-solid fa-file-invoice-dollar"></i></i>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- card2 -->
        <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
          <div class="relative flex flex-col min-w-0 break-words bg-gradient-to-tl from-red-600 to-orange-600 shadow-xl dark:bg-slate-850 dark:shadow-dark-xl text-white rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                ...
                <div class="px-3 text-right basis-1/3">
                  <div class="inline-block w-12 h-12 text-center rounded-circle bg-white">
                    <i class="ni leading-none ni-world text-lg relative top-3.5 text-gray-900"><i class="fa-solid fa-file-lines"></i></i>
                  </div>
                </div>
              </div>
            </div>
        ...
        <!-- card3 -->
        <div class="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/4">
          <div class="relative flex flex-col min-w-0 break-words bg-white  bg-gradient-to-tl text-white from-emerald-500 to-teal-400 text-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                ...
                <div class="px-3 text-right basis-1/3">
                  <div class="inline-block w-12 h-12 text-center rounded-circle bg-white">
                    <i class="ni leading-none ni-paper-diploma text-lg relative top-3.5 text-gray-900"> <i class="fa-solid fa-users"></i></i>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="w-full max-w-full px-3 sm:w-1/2 sm:flex-none xl:w-1/4">
          <div class="relative flex flex-col min-w-0 break-words bg-white shadow-xl bg-gradient-to-tl text-white from-orange-500 to-yellow-500 dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
            <div class="flex-auto p-4">
              <div class="flex flex-row -mx-3">
                <div class="flex-none w-2/3 max-w-full px-3">
                  <div>
                    <p class="mb-0 font-sans text-sm font-semibold leading-normal uppercase dark:text-white dark:opacity-60">Avoir</p>
                ...
                <div class="px-3 text-right basis-1/3">
                  <div class="inline-block w-12 h-12 text-center rounded-circle bg-white">
                    <i class="ni leading-none ni-cart text-lg relative top-3.5 text-gray-900"><i class="fa-regular fa-rectangle-xmark"></i></i>
                  </div>
                </div>
              </div>
            </div>
