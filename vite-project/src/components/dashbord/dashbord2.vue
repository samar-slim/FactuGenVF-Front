    ...
    <div class="flex flex-wrap mt-5 mx-5 removable">
      ...
      <div class="w-full max-w-full px-3 mb-6 sm:w-1/4 sm:flex-none xl:mb-0 xl:w-1/4 drop-zone">
        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable" draggable="true">
          ...
          <div class="flex flex-col items-start justify-between flex-auto py-8 px-9">
            <div class="m-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-[35px] text-blue-500">
                <path d="M3 4h14v2H3V4zm0 6h14v2H3v-2zm0 6h14v2H3v-2z"></path>
              </svg>
            </div>
      ...
      <div class="w-full max-w-full px-3 mb-6 sm:w-1/4 sm:flex-none xl:mb-0 xl:w-1/4 drop-zone">
        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable" draggable="true">
          ...
          <div class="flex flex-col items-start justify-between flex-auto py-8 px-9">
            <div class="m-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-[35px] text-green-500">
                <path d="M3 4h14v2H3V4zm0 6h14v2H3v-2zm0 6h14v2H3v-2z"></path>
              </svg>
            </div>
            <div class="flex flex-col my-7">
              <span class="text-secondary-inverse text-4xl tracking-[-0.115rem] font-bold">58k</span>
              <div class="m-0">
      ...
      <div class="w-full max-w-full px-3 mb-6 sm:w-1/4 sm:flex-none xl:mb-0 xl:w-1/4 drop-zone">
        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable" draggable="true">
          ...
          <div class="flex flex-col items-start justify-between flex-auto py-8 px-9">
            <div class="m-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-[35px] text-red-500">
                <path d="M3 4h14v2H3V4zm0 6h14v2H3v-2zm0 6h14v2H3v-2z"></path>
              </svg>
            </div>
            <div class="flex flex-col my-7">
              <span class="text-secondary-inverse text-4xl tracking-[-0.115rem] font-bold">896k</span>
              <div class="m-0">
                <span class="font-medium text-secondary-dark text-lg/normal">Followers</span>
              </div>
            </div>
      ...
      <div class="w-full max-w-full px-3 mb-6 sm:w-1/4 sm:flex-none xl:mb-0 xl:w-1/4 drop-zone">
        <div class="relative flex flex-col min-w-0 break-words border border-dashed bg-clip-border rounded-2xl border-stone-200 bg-light/30 draggable" draggable="true">
          ...
          <div class="flex flex-col items-start justify-between flex-auto py-8 px-9">
            <div class="m-0">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-[35px] text-yellow-500">
                <path d="M3 4h14v2H3V4zm0 6h14v2H3v-2zm0 6h14v2H3v-2z"></path>
              </svg>
            </div>
            <div class="flex flex-col my-7">
  ...
  <div v-if="isOpen" class="  container mx-auto p-4 shadow-lg p-10 rounded">
    ...
    <div class="relative bg-white rounded-lg shadow ...">
        ...
        <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t ...">
          <h3 class="text-xl font-semibold text-gray-900 ...">Nouveau Facture</h3>
    ...
    <div class="mb-8">
      ...
      <div class="py-4"> 
        ...
        <div class="flex items-center p-4 md:p-5 border-t ...">
          <button @click="acceptTerms" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" >Enregistrer</button>
